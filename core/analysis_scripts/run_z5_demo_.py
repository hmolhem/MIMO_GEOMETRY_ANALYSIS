...
from core.radarpy.geometry.z5_processor_ import Z5ArrayProcessor

def main():
    """Initializes and runs the analysis for the Array Z5 (w(1)=w(2)=0)."""
    
    # --- Configuration ---
    N_sensors = 8  # Minimum N=5 required
    ...
    print("\n" + "="*40)
    print("      ARRAY Z5 PERFORMANCE SUMMARY (Expected w(1)=w(2)=0)")
    print("="*40)
