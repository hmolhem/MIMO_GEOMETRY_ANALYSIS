# analysis_scripts/run_z3_1_demo.py
...
from core.radarpy.geometry.z3_1_processor_ import Z3_1ArrayProcessor

def main():
    """Initializes and runs the analysis for the Array Z3(1)."""
    
    # --- Configuration ---
    N_sensors = 6  # Minimum N=5 required
    
    print(f"--- Starting Array Z3(1) (N={N_sensors}) Analysis Demo ---")
    
    # Instantiate the processor: Array Z3(1)
    z3_1_processor = Z3_1ArrayProcessor(N=N_sensors, d=1)
    
    # Run the full analysis pipeline
    analysis_results = z3_1_processor.run_full_analysis()
